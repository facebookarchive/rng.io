(function( window, _, $ ) {
  ...
  Rng = {
    ...
    init: function() {
      ...
      //   Rng.Views( initializer, this, function() {
      //     if ( Rng.isRoot ) {
      //       this.run();
      //     }
      //   });
      ...
      //   //       nodes["#rng-view-devices"].innerHTML = templates["devices-tpl"]({
      //   //         options: (function() {
    ...
    run: function() {
      ...
      // nodes = {
      //   report: nodes["#rng-view-report"],
      //   summary: nodes["#rng-view-summary"],
      //   completed: nodes["#rng-view-completed"],
      //   devices: nodes["#rng-view-devices"]
      // };
      ...
      Hat.on("runner:done", function( data ) {
        ...
        if ( completed === Hat.ring.cache.length || override ) {
          ...
          //   // console.log( "http://www.browserscope.org/user/tests/table/" + Rng.Browserscope.keys.all + "?v=top-m&o=json" );

          //   // Display "Other Devices" Select Menu
          //   Rng.Request.jsonp(
          //     "http://www.browserscope.org/user/tests/table/" + Rng.Browserscope.keys.rings + "?v=top-m&o=json",
          //     function( data ) {
